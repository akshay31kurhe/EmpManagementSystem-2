...
public class EmployeeServices
{
	...
	{
		eresp.save(e);
		return "Employee records added sucessfully";
	}
	...
	{
		return eresp.findByFirstname(fname);
	}
	public List<Employee>findbylastname(String lname)
	{
		return eresp.findByLastname(lname);
	}
	...
	public String updatebyid(int empid,Employee newemp)
	{
		  ...
		  {
			  existingemp.setReportingauthority(newemp.getReportingauthority());
		  }
